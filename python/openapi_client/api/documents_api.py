...
class DocumentsApi:
    ...
    def document_controller_upload_document(
        ...
        _param = self._document_controller_upload_document_serialize(
            file=file,
            monetized=monetized,
            file_hash=file_hash,
    ...
    def _document_controller_upload_document_serialize(
        self,
        file,
        monetized,
        file_hash,
        ...
        if monetized is not None:
            _form_params.append(('monetized', monetized))
        if file_hash is not None:
            _form_params.append(('fileHash', file_hash))
        if derived_key is not None:
            _form_params.append(('derivedKey', derived_key))
        if password is not None:
            _form_params.append(('password', password))
        if is_id is not None:
            _form_params.append(('isID', is_id))
        if task_id is not None:
            _form_params.append(('taskId', task_id))
