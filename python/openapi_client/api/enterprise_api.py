...
class EnterpriseApi:
    ...
    @validate_call
    def enterprise_controller_auth(
        self,
        auth_dto: AuthDTO,
        ...
        _param = self._enterprise_controller_auth_serialize(
            auth_dto=auth_dto,
    ...
    @validate_call
    def enterprise_controller_auth_with_http_info(
        self,
        auth_dto: AuthDTO,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def enterprise_controller_auth_without_preload_content(
        self,
        auth_dto: AuthDTO,
        _request_timeout: Union[
            None,
    ...
    def _enterprise_controller_auth_serialize(
        self,
        auth_dto,
        _request_auth,
        _content_type,
        ...
        if auth_dto is not None:
            _body_params = auth_dto
    ...
    @validate_call
    def enterprise_controller_import_clients(
        self,
        import_clients_dto: ImportClientsDTO,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._enterprise_controller_import_clients_serialize(
            import_clients_dto=import_clients_dto,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def enterprise_controller_import_clients_with_http_info(
        self,
        import_clients_dto: ImportClientsDTO,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def enterprise_controller_import_clients_without_preload_content(
        self,
        import_clients_dto: ImportClientsDTO,
        _request_timeout: Union[
            None,
    ...
    def _enterprise_controller_import_clients_serialize(
        self,
        import_clients_dto,
        _request_auth,
        _content_type,
        ...
        # process the form parameters
        # process the body parameter
        if import_clients_dto is not None:
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/enterprise/import-clients',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
