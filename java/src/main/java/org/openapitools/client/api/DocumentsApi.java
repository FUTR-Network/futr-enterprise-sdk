...
public class DocumentsApi {
     ...
     * @param fileHash SHA-256 hash of the file content for integrity verification (hex string) (required)
     * @param xClientEmail user&#39;s email address (for enterprise use only, end-client should skip this header) (optional)
     * @param derivedKey derived encryption key for the document               Users without a CMK or are **Enterprises** can skip this property.             For end-clients with a CMK, this should be provided to enable encryption at rest and decryption for agent queries.             For enterprise clients, this property should be skipped.              (optional)
